...
@NotThreadSafe
public class BootstrappedIgnite3ServerTask implements ComputeJob<String, BootstrappedIgnite3ServerTask.TaskResult> {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                try {
                    ...
                    BootstrappedIgnite3ServerTaskMain.main(args);
