...
@NotThreadSafe
public class BootstrappedIgnite3ServerTaskMain extends AMain {
    ...
    public BootstrappedIgnite3ServerTaskMain(final String[] args) {
    ...
    public static void main(final String[] args) {
        new BootstrappedIgnite3ServerTaskMain(args).run();
    }
}