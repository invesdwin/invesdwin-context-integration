package de.invesdwin.context.integration.grid.ignite3.server.bootstrapped;
...
import de.invesdwin.context.integration.grid.ignite3.server.bootstrapped.job.BootstrappedIgnite3ServerJobMain;
import de.invesdwin.context.integration.grid.ignite3.server.bootstrapped.job.BootstrappedIgnite3ServerTask;
...
@NotThreadSafe
public class BootstrappedIgnite3ServerTest extends ATest {
    ...
    public void test() throws Exception {
        ...
        final File jobJarFile = new MergedClasspathJar(
                DefaultMergedClasspathJarFilter.DEFAULT /*
                                                         ...
                                                         */, BootstrappedIgnite3ServerTask.class).getResource().getFile();

        // 1. Fork the worker node asynchronously via ForkJobHelper
        final StartedProcess workerProcess = new ForkProcessHelper().forkAsync(BootstrappedIgnite3ServerJobMain.class,
        ...
        try {
            ...
            BootstrappedIgnite3ServerJobMain.main(new String[] { "--nodeName", "master-node", "--port", "3344", "--size",
