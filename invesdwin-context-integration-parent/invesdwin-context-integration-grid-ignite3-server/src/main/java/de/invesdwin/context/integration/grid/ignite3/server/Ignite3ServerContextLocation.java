...
@ThreadSafe
@Named
public class Ignite3ServerContextLocation extends AConditionalContextLocation {

    public static final PositionedResource SERVER_CONTEXT_LOCATION;

    private static volatile boolean activated = Ignite3ServerProperties.STARTUP_ENABLED;

    static {
        Assertions.checkNotNull(PreMergedContext.getInstance());
        SERVER_CONTEXT_LOCATION = PositionedResource.of(new ClassPathResource("/META-INF/ctx.ignite3.server.xml"),
