...
@Immutable
public final class Ignite3ServerProperties {
    ...
    static {
        final SystemProperties systemProperties = new SystemProperties(Ignite3ServerProperties.class);
    ...
    private Ignite3ServerProperties() {}
