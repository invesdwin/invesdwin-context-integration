package de.invesdwin.context.integration.grid.hadoop;
...
@Immutable
public enum HadoopMergedClasspathJarFilter implements IMergedClasspathJarFilter {
    HADOOP2 {
        @Override
    ...
    private static final String[] HADOOP3_BLACKLIST = Arrays.concat(
            DefaultMergedClasspathJarFilter.DEFAULT.getBlacklist(),
