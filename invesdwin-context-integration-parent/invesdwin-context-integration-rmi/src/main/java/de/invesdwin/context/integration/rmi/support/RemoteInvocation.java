...
/**
 * Encapsulates a remote invocation, providing core method invocation properties in a serializable fashion. Used for RMI
 * and HTTP-based serialization invokers.
 *
 * <p>
 ...
 * @see de.invesdwin.context.integration.rmi.rmi.RmiProxyFactoryBean
 * @see de.invesdwin.context.integration.rmi.rmi.RmiServiceExporter
...
public class RemoteInvocation implements Serializable {
    ...
    /**
     * Add an additional invocation attribute. Useful to add additional invocation context without having to subclass
     * RemoteInvocation.
     * <p>
    ...
    /**
     * Set the attributes Map. Only here for special purposes: Preferably, use {@link #addAttribute} and
     * {@link #getAttribute}.
     *
     * @param attributes
     *            the attributes Map
     ...
     * @see #getAttribute
     */
    public void setAttributes(@Nullable final Map<String, Serializable> attributes) {
        this.attributes = attributes;
    }

    /**
     * Return the attributes Map. Mainly here for debugging purposes: Preferably, use {@link #addAttribute} and
     * {@link #getAttribute}.
     *
