 ...
 *
 * <p>
 * Used by {@link de.invesdwin.context.integration.rmi.rmi.RmiClientInterceptor} (for RMI invokers) and by
 * {@link org.springframework.remoting.httpinvoker.HttpInvokerClientInterceptor}.
 *
 * @author Juergen Hoeller
 * @since 1.1
 * @see DefaultRemoteInvocationFactory
 * @see de.invesdwin.context.integration.rmi.rmi.RmiClientInterceptor#setRemoteInvocationFactory
