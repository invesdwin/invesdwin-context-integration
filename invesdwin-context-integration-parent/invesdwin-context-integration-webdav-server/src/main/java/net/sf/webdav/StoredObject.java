...
public class StoredObject {
     ...
     */
    public void setFolder(final boolean f) {
        this.isFolder = f;
    }
     ...
     */
    public void setLastModified(final Date d) {
        this.lastModified = d;
    }
     ...
     */
    public void setResourceLength(final long l) {
     ...
     */
    public void setNullResource(final boolean f) {
