...
public class LocalFileSystemStore implements IWebdavStore {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(LocalFileSystemStore.class);
    ...
    @Override
    public ITransaction begin(final Principal principal) throws WebdavException {
    ...
    @Override
    public void checkAuthentication(final ITransaction transaction) throws SecurityException {
    ...
    @Override
    public void commit(final ITransaction transaction) throws WebdavException {
        // do nothing
        LOG.trace("LocalFileSystemStore.commit()");
    }

    @Override
    public void rollback(final ITransaction transaction) throws WebdavException {
        // do nothing
    ...
    @Override
    public void createFolder(final ITransaction transaction, final String uri) throws WebdavException {
        LOG.trace("LocalFileSystemStore.createFolder(" + uri + ")");
        final File file = new File(root, uri);
        if (!file.mkdir()) {
    ...
    @Override
    public void createResource(final ITransaction transaction, final String uri) throws WebdavException {
    ...
    @Override
    public long setResourceContent(final ITransaction transaction, final String uri, final InputStream is,
            final long contentLength) throws WebdavException {
    ...
    @Override
    public String[] getChildrenNames(final ITransaction transaction, final String uri) throws WebdavException {
    ...
    @Override
    public InputStream getResourceContent(final ITransaction transaction, final String uri) throws WebdavException {
    ...
    @Override
    public long getResourceLength(final ITransaction transaction, final String uri) throws WebdavException {
