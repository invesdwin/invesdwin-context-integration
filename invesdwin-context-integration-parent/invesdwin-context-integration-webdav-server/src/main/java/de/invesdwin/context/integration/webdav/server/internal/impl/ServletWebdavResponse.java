...
public class ServletWebdavResponse implements WebdavResponse {
    ...
    @Override
    public void sendError(final WebdavStatus status) throws IOException {
        resp.sendError(status.code());
    }

    @Override
    public void sendError(final WebdavStatus status, final String requestUri) throws IOException {
