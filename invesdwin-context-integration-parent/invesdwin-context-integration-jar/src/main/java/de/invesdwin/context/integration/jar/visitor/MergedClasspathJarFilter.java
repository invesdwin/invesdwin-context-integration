...
public enum MergedClasspathJarFilter implements IMergedClasspathJarFilter {
    ...
    private static final String[] HADOOP_BLACKLIST = Arrays.concat(DEFAULT_BLACKLIST,
            new String[] { "org/apache/hadoop/.*", "javax/inject/.*", "org/codehaus/jackson/.*", "org/mockito/.*",
                    ...
                    "com/google/protobuf/.*", "org/apache/commons/math/.*", "org/aopalliance/.*",
                    "org/apache/commons/lang/.*", "org/apache/avro/.*", "com/thoughtworks/paranamer/.*", "org/junit/.*",
                    "org/objenesis/.*", "org/hamcrest/.*", "org/apache/commons/beanutils/.*", "org/xerial/snappy/.*",
