...
import de.invesdwin.context.integration.grid.ignite2.instance.Ignite2InstanceProcessingThreadsCounter;
...
@ThreadSafe
public class Ignite2ClientProcessingThreadsCounter {

    public static final Duration REFRESH_INTERVAL = Duration.ONE_MINUTE;

    public static final String WEBDAV_DIRECTORY = Ignite2InstanceProcessingThreadsCounter.WEBDAV_DIRECTORY;
    public static final String WEBDAV_CONTENT_SEPARATOR = Ignite2InstanceProcessingThreadsCounter.WEBDAV_CONTENT_SEPARATOR;
    public static final String WEBDAV_CONTENT_DATEFORMAT = Ignite2InstanceProcessingThreadsCounter.WEBDAV_CONTENT_DATEFORMAT;
    public static final Duration HEARTBEAT_TIMEOUT = Ignite2InstanceProcessingThreadsCounter.HEARTBEAT_TIMEOUT;

    public static final String DRIVER_HEARTBEAT_FILE_PREFIX = Ignite2InstanceProcessingThreadsCounter.DRIVER_HEARTBEAT_FILE_PREFIX;
    public static final String NODE_HEARTBEAT_FILE_PREFIX = Ignite2InstanceProcessingThreadsCounter.NODE_HEARTBEAT_FILE_PREFIX;
    ...
    private Triple<List<Integer>, Map<String, String>, Map<String, String>> countProcessingThreads() {
        ...
        // Gather online node UUIDs from the thin client's cluster topology view
        ...
        processHeartbeats(processingThreads, localServerInfos, localNodeInfos, onlineNodeUuids);
                ...
                if (listFiles != null && !listFiles.isEmpty()) {
                    try (ICloseableMap<String, HeartbeatInfo> hostname_heartbeatinfo = PooledLinkedMap.getInstance()) {
                        ...
                        for (final HeartbeatInfo heartbeatInfo : hostname_heartbeatinfo.values()) {
                            final boolean isOnline = onlineNodeUuids.contains(heartbeatInfo.getUuid());
    ...
    private void logDetectedCounts() {
        ...
        message.append(Ignite2ClientProcessingThreadsCounter.class.getSimpleName());
