 ...
 */
@ThreadSafe
public final class AprDatagramAcceptor extends AbstractPollingIoAcceptor<AprSession, Long> {
    /**
    ...
    /**
     * Constructor for {@link AprDatagramAcceptor} using default parameters (multiple thread model).
     */
    ...
    /**
     * Constructor for {@link AprDatagramAcceptor} using default parameters, and given number of
     ...
     */
    public AprDatagramAcceptor(final int processorCount) {
        super(new DefaultSocketSessionConfig(), AprDatagramIoProcessor.class, processorCount);
        ((DefaultSocketSessionConfig) getSessionConfig()).init(this);
    }

    /**
     * Constructor for {@link AprDatagramAcceptor} with default configuration but a specific
     * {@link AprDatagramIoProcessor}, useful for sharing the same processor over multiple {@link IoService} of the same
     * type.
     *
     * @param processor
     *            the processor to use for managing I/O events
     */
    public AprDatagramAcceptor(final IoProcessor<AprSession> processor) {
        super(new DefaultSocketSessionConfig(), processor);
        ((DefaultSocketSessionConfig) getSessionConfig()).init(this);
    }

    /**
     * Constructor for {@link AprDatagramAcceptor} with a given {@link Executor} for handling connection events and a
     * given {@link AprDatagramIoProcessor} for handling I/O events, useful for sharing the same processor and executor
     * over multiple {@link IoService} of the same type.
     *
     * @param executor
     ...
     */
    public AprDatagramAcceptor(final Executor executor, final IoProcessor<AprSession> processor) {
