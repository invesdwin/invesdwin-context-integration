...
public final class AprSctpConnector extends AbstractPollingIoConnector<AprSession, Long> implements SocketConnector {
    ...
    /**
     * Constructor for {@link AprSctpConnector} with default configuration, and given number of
    ...
    /**
     * Constructor for {@link AprSctpConnector} with default configuration but a specific {@link IoProcessor}, useful
     * for sharing the same processor over multiple {@link IoService} of the same type.
     *
     * @param processor
     *            the processor to use for managing I/O events
     */
    public AprSctpConnector(final IoProcessor<AprSession> processor) {
        super(new DefaultSocketSessionConfig(), processor);
        ((DefaultSocketSessionConfig) getSessionConfig()).init(this);
    }

    /**
     * Constructor for {@link AprSctpConnector} with a given {@link Executor} for handling connection events and a given
     * {@link IoProcessor} for handling I/O events, useful for sharing the same processor and executor over multiple
     ...
     */
    public AprSctpConnector(final Executor executor, final IoProcessor<AprSession> processor) {
