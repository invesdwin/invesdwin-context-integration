...
@NotThreadSafe
public class JucxTagSynchronousReader implements ISynchronousReader<IByteBufferProvider> {
    ...
    public JucxTagSynchronousReader(final JucxTagSynchronousChannel channel) {
