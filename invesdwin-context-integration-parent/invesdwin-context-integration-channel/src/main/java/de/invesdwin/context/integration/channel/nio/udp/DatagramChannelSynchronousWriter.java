...
@NotThreadSafe
public class DatagramChannelSynchronousWriter extends ADatagramChannelSynchronousChannel
        implements ISynchronousWriter<byte[]> {

    public DatagramChannelSynchronousWriter(final SocketAddress socketAddress, final int estimatedMaxMessageSize) {
