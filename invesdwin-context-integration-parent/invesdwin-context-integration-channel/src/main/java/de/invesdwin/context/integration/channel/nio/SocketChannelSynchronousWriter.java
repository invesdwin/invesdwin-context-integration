...
@NotThreadSafe
public class SocketChannelSynchronousWriter extends ASocketChannelSynchronousChannel implements ISynchronousWriter<byte[]> {

    private BufferedOutputStream out;

    public SocketChannelSynchronousWriter(final SocketAddress socketAddress, final boolean server, final int estimatedMaxMessageSize) {
