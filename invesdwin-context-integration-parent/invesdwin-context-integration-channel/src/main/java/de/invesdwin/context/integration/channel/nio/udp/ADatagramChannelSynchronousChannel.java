...
@NotThreadSafe
public abstract class ADatagramChannelSynchronousChannel implements ISynchronousChannel {
    ...
    public ADatagramChannelSynchronousChannel(final SocketAddress socketAddress, final boolean server,
