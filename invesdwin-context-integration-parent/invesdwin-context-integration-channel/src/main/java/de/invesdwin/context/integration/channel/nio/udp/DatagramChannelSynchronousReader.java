package de.invesdwin.context.integration.channel.nio.udp;
...
@NotThreadSafe
public class DatagramChannelSynchronousReader extends ADatagramChannelSynchronousChannel
        implements ISynchronousReader<byte[]> {

    public DatagramChannelSynchronousReader(final SocketAddress socketAddress, final int estimatedMaxMessageSize) {
