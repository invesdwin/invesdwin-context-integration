...
@NotThreadSafe
public class SocketChannelSynchronousReader extends ASocketChannelSynchronousChannel implements ISynchronousReader<byte[]> {
    ...
    public SocketChannelSynchronousReader(final SocketAddress socketAddress, final boolean server, final int estimatedMaxMessageSize) {
