...
@NotThreadSafe
public class DarpcServerSynchronousWriter implements ISynchronousWriter<IByteBufferProvider> {
    ...
    public DarpcServerSynchronousWriter(final DarpcServerSynchronousChannel channel) {
    ...
    public void open() throws IOException {
        ...
        messageBuffer = new SlicedFromDelegateByteBuffer(buffer, DarpcServerSynchronousChannel.MESSAGE_INDEX);
    }
    ...
    public void write(final IByteBufferProvider message) throws IOException {
        try {
            ...
            buffer.putInt(DarpcServerSynchronousChannel.SIZE_INDEX, size);
            messageToWrite = buffer.addressOffset();
            ByteBuffers.position(nioBuffer, 0);
            ByteBuffers.limit(nioBuffer, DarpcServerSynchronousChannel.MESSAGE_INDEX + size);
