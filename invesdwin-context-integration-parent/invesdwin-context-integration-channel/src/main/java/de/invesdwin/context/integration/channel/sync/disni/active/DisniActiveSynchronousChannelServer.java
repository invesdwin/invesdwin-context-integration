...
public class DisniActiveSynchronousChannelServer implements ISynchronousReader<DisniActiveSynchronousChannel> {
    ...
    public void open() throws IOException {
        ...
        final DisniActiveRdmaEndpointFactory factory = new DisniActiveRdmaEndpointFactory(
                finalizer.endpointGroup, socketSize);
    ...
    private static final class DisniActiveSynchronousChannelFinalizer extends AFinalizer {
        ...
        protected DisniActiveSynchronousChannelFinalizer() {
        ...
        protected void clean() {
            final DisniActiveRdmaEndpoint socketChannelCopy = pendingEndpoint;
            if (socketChannelCopy != null) {
                pendingEndpoint = null;
                Closeables.closeQuietly(socketChannelCopy);
            }
            final RdmaServerEndpoint<DisniActiveRdmaEndpoint> serverSocketChannelCopy = serverEndpoint;
    ...
    public boolean hasNext() throws IOException {
        ...
        final RdmaServerEndpoint<DisniActiveRdmaEndpoint> serverSocketChannelCopy = finalizer.serverEndpoint;
        if (serverSocketChannelCopy == null) {
