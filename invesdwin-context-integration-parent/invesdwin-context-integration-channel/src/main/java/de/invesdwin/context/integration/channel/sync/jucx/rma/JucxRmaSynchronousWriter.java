...
@NotThreadSafe
public class JucxRmaSynchronousWriter implements ISynchronousWriter<IByteBufferProvider> {
    ...
    public JucxRmaSynchronousWriter(final JucxRmaSynchronousChannel channel) {
