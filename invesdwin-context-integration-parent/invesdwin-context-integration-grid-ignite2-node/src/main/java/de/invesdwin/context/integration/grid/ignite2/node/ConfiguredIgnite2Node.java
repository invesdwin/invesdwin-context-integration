    ...
    public synchronized void start() {
        ...
        NODE_EXECUTOR.execute(new Runnable() {
            ...
            public void run() {
                ...
                configuration.setClientMode(Ignite2NodeProperties.CLIENT_MODE);
                ...
                tcpCommunicationSpi
                        .setForceClientToServerConnections(Ignite2NodeProperties.FORCE_CLIENT_TO_SERVER_CONNECTIONS);
