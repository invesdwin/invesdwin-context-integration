package de.invesdwin.context.integration.ignite.test.simple;
...
import de.invesdwin.context.integration.ignite.test.IgniteContainer;
import de.invesdwin.context.integration.ignite.test.simple.job.IgniteJobMain;
...
@Testcontainers
@NotThreadSafe
public class IgniteServerTest extends ATest {

    private static final int NUM_CONTAINERS = 2;

    @Container
    private static final IgniteContainer IGNITE = new IgniteContainer();
    ...
    public void test() throws Exception {
        ...
        IgniteJobMain.main(new String[] { "--size", String.valueOf(NUM_CONTAINERS), "--logDir",
