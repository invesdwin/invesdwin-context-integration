// @NotThreadSafe
// CHECKSTYLE:OFF
package de.invesdwin.context.integration.channel.jucx.examples;
...
public abstract class UcxBenchmark {
     ...
     */
    protected static boolean initializeArguments(final String[] args) {
    ...
    protected static double getBandwithGbits(final long nanoTimeDelta, final long size) {
        return size * 8.0 / nanoTimeDelta;
    }
