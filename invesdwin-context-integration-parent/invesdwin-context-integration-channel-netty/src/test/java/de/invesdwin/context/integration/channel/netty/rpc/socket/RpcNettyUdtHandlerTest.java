...
import de.invesdwin.context.integration.channel.netty.async.udt.NettyUdtAsynchronousChannel;
import de.invesdwin.context.integration.channel.netty.sync.udt.NettySharedUdtEndpointFactory;
import de.invesdwin.context.integration.channel.netty.sync.udt.NettyUdtSynchronousChannel;
import de.invesdwin.context.integration.channel.netty.sync.udt.type.INettyUdtChannelType;
import de.invesdwin.context.integration.channel.netty.sync.udt.type.NioNettyUdtChannelType;
...
public class RpcNettyUdtHandlerTest extends AChannelTest {
    ...
    protected void runRpcTest(final RpcLatencyChannelTest test, final InetSocketAddress address,
        ...
        final ISynchronousEndpointFactory<IByteBufferProvider, IByteBufferProvider> clientEndpointFactory = new NettySharedUdtEndpointFactory(
