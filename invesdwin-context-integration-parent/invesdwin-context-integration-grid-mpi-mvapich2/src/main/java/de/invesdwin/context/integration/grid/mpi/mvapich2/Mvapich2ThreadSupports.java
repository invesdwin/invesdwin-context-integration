package de.invesdwin.context.integration.grid.mpi.mvapich2;

import javax.annotation.concurrent.Immutable;

import de.invesdwin.context.integration.grid.mpi.MpiThreadSupport;
import de.invesdwin.util.error.UnknownArgumentException;
import mpi.MPI;

@Immutable
public final class Mvapich2ThreadSupports {

    private Mvapich2ThreadSupports() {}
