package de.invesdwin.context.integration.channel.pulsar.serde;
...
@NotThreadSafe
public class PulsarNettyDelegateByteBuffer implements IByteBuffer {

    public static final ByteBuf EMPTY_BYTES = Unpooled.wrappedBuffer(Bytes.EMPTY_ARRAY);
    public static final PulsarNettyDelegateByteBuffer EMPTY_BUFFER = new PulsarNettyDelegateByteBuffer(EMPTY_BYTES);

    private ByteBuf delegate;
    private IMutableSlicedDelegateByteBufferFactory mutableSliceFactory;

    public PulsarNettyDelegateByteBuffer(final ByteBuf delegate) {
        setDelegate(delegate);
    }

    public PulsarNettyDelegateByteBuffer() {}
