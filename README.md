...
Network    NettyDatagramIOUring (loopback)        Records:     27.80/ms    => ~74% slower
Thread     NngInproc                              Records:     28.93/ms    => ~73% slower
Network    NettySocketIOUring (loopback)          Records:     30.49/ms    => ~71% slower
Network    NettyDatagramNio (loopback)            Records:     31.06/ms    => ~71% slower
...
Network    BidiNettyDatagramIOUring (loopback)    Records:     34.80/ms    => ~68% slower
Network    CzmqTcp (loopback)                     Records:     35.24/ms    => ~67% slower
Network    JnanomsgTcp (loopback)                 Records:     35.90/ms    => ~66% slower
Network    BidiNettyDatagramNio (loopback)        Records:     37.95/ms    => ~64% slower
...
Network    MinaNativeDatagramChannel (loopback)   Records:    316.37/ms    => ~3 times as fast (unreliable)
