...
Network    ChronicleNetwork (loopback)            Records:   133.49/ms    => ~25% faster (using UsafeFastJ8SocketChannel to skip some NIO internal synchronization)
Network*   AeronUDP (loopback)                    Records:   176.53/ms    => ~65% faster
Network    DatagramChannel (loopback)             Records:   248.51/ms    => ~2.3 times faster (unreliable)
...
Thread     LinkedBlockingDeque                    Records:  1520.45/ms    => ~14.3 times faster
...
Thread     ConcurrentLinkedDeque                  Records:  2844.95/ms    => ~26.7 times faster
...
Thread     NettyMpscQueue                         Records:  3924.65/ms    => ~36.8 times faster
Thread     NettySpscQueue                         Records:  3995.21/ms    => ~37.5 times faster
Thread     NettyFixedMpscQueue                    Records:  4083.30/ms    => ~38.3 times faster
