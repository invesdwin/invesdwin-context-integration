...
- **invesdwin-context-integration-maven**: this module adds support for downloading artifacts from maven repositories. With this one can implement dynamic loading of plugins via the web.
