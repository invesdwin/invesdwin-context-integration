...
Network    BidiNettySocketHadroNio (SoftRoCE)     Records:     62.98/ms    => ~41% slower
...
Network    NettySocketHadroNio (SoftRoCE)         Records:     65.40/ms    => ~39% slower (crashes after ~500k records)
...
Network    HadroNioSocketChannel (SoftRoCE)       Records:     80.59/ms    => ~24% slower
Network    BidiHadroNioSocketChannel (SoftRoCE)   Records:     80.63/ms    => ~24% slower
...
Network    AsyncNettySocketHadroNio (SoftRoCE)    Records:     85.99/ms    => ~19% slower
...
Network    BidiJucxTag (SoftRoCE, PEH)            Records:    115.25/ms    => ~8% faster (PeerErrorHandling, crashes after ~5 million records)
Network    BidiJucxStream (SoftRoCE, PEH)         Records:    129.80/ms    => ~22% faster (PeerErrorHandling, crashes after ~5 million records)
...
Network    JucxStream (SoftRoCE, PEH)             Records:    132.55/ms    => ~24% faster (PeerErrorHandling, crashes after ~5 million records)
...
Network    JucxTag (SoftRoCE, PEH)                Records:    134.61/ms    => ~26% faster (PeerErrorHandling, crashes after ~5 million records)
...
Network    BidiJucxStream (SoftRoCE, noPEH)       Records:    372.39/ms    => ~3.5 times as fast (NoPeerErrorHandling)
Network    JucxTag (SoftRoCE, noPEH)              Records:    373.87/ms    => ~3.5 times as fast (NoPeerErrorHandling)
Network    BidiJucxTag (SoftRoCE, noPEH)          Records:    376.11/ms    => ~3.5 times as fast (NoPeerErrorHandling)
Network    JucxStream (SoftRoCE, noPEH)           Records:    389.01/ms    => ~3.6 times as fast (NoPeerErrorHandling)
