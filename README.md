...
Network    JucxTag (loopback)                     Records:     66.56/ms    => ~35% slower
...
Network    JucxStream (loopback)                  Records:     68.82/ms    => ~33% slower
...
Network    BidiJucxTag (loopback)                 Records:     79.03/ms    => ~23% slower
Network    AsyncNettyDatagramNio (loopback)       Records:     80.97/ms    => ~24% slower (unreliable; using async handlers for servers)
Network    BidiJucxStream (loopback)              Records:     85.19/ms    => ~17% slower (supports Infiniband and other specialized hardware)
...
Process    JucxTag (shared memory)                Records:    449.78/ms    => ~4.4 times as fast
Process    BidiJucxTag (shared memory)            Records:    454.30/ms    => ~4.4 times as fast
Process    JucxStream (shared memory)             Records:    465.33/ms    => ~4.5 times as fast
Process    BidiJucxStream (shared memory)         Records:    466.50/ms    => ~4.5 times as fast
