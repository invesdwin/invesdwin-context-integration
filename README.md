...
Network    BidiMinaSctpApr (loopback)             Records:     24.82/ms    => ~77% slower
Thread     NngInproc                              Records:     28.93/ms    => ~73% slower
Network    NettySocketIOUring (loopback)          Records:     29.97/ms    => ~72% slower
Network    AsyncMinaSctpApr (loopback)            Records:     36.33/ms    => ~66% slower (using async handlers for servers)
