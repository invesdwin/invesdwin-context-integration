...
Process    ChronicleQueue                         Records:   275.52/ms    => ~2.6 times as fast
Process    ChronicleQueue (tmpfs)                 Records:   282.06/ms    => ~2.65 times as fast
Thread     JeromqInproc                           Records:   296.34/ms    => ~2.8 times as fast
Process    NamedPipe (Streaming)                  Records:   350.07/ms    => ~3.3 times as fast
Process    UnixDomainSocket                       Records:   375.64/ms    => ~3.5 times as fast (requires Java 16 for NIO support)
