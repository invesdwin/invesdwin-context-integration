...
Network    NettyDatagramIOUring (loopback)        Records:     32.20/ms    => ~% slower
...
Network    NettyDatagramNio (loopback)            Records:     35.34/ms    => ~% slower
...
Network    BidiNettyDatagramIOUring (loopback)    Records:     40.48/ms    => ~% slower
...
Network    BidiNettyDatagramNio (loopback)        Records:     44.99/ms    => ~58% slower
