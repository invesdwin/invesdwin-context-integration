...
Process    Jocket                                 Records:  1204.82/ms    => ~11.3 times faster (Jocket is unstable, deadlocks after 2-3 million messages, their tests show ~1792.11/ms which would be ~16.8 times faster)
